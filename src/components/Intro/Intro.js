    ...
    return (
        <section className="main__content-intro">
            <div className="main__content-intro--container">
                ...
                <button onClick={props.handleCustomerLoginToggle} className="customer__btn">Customer Login</button>
                <button onClick={props.handleBusinessLoginToggle} className="business__btn">Business Login</button>
            </div>
        </section>
    )
}
